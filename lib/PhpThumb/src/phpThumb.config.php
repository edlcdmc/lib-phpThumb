...
$PHPTHUMB_CONFIG['cache_directory'] =  __DIR__.'/../../../../app/cache/';     // set the cache directory relative to the phpThumb() installation
//$PHPTHUMB_CONFIG['cache_directory'] = DIR_RF_IMAGES_CACHE;                            		// set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_maxsize'] = 500 * 1024 * 1024; // delete least-recently-accessed cached thumbnails when more than [10MB] of cached files are present (value is maximum bytesize of all cached files)
...
$PHPTHUMB_CONFIG['cache_prefix'] = 'phpThumb_cache_';                         // allow phpThumb to share 1 set of cached files even if accessed under different servername/domains on same server
...
$PHPTHUMB_CONFIG['temp_directory'] = __DIR__.'/../../../../app/cache/';  // set to absolute path
...
$PHPTHUMB_CONFIG['ttf_directory'] = __DIR__.'/../../../../app/cache/phpThumb/fonts/'; // Base directory for TTF font files
//$PHPTHUMB_CONFIG['ttf_directory'] = DIR_RF_DATA.'fonts/'; // Base directory for TTF font files
